...
namespace Player
{
    public class PlayerController : MonoBehaviour
    {
        ...
        {
            GameEvents.OnEnemyAttack += TakeDamage;
        }
        ...
        public void MovePlayer()
        {
            ...
            //Debug.Log($"Moving player: Horizontal = {horizontalInput}, Velocity = {rb.velocity}");
        }
        #endregion
        ...
        public void DealDamage()
        {
            ...
            {
                GameEvents.OnPlayerAttack?.Invoke(playerData.MaxAtk, transform.position);
            }
        }

        void TakeDamage()
        {
            stateMachine.ChangeState(PlayerStateID.Hurt);
